...
/**
 *	indica o ponto médio da lista
 *	parametro: 1st apontador para a lista
 *	retorno: apontador para o elemento do meio da lista
 */
...
*  retorno: apontador para o elemento na posicao correspondente
 ...
 *  parametro: lst apontador para a lista
 *  parametro: valor inteiro a inserir
...
*  parametro: valor inteiro pretendido
 ...
 *  parametro: lst apontador para a lista
 *  parametro: valor inteiro a pesquisar
...
/**
 *  ordena uma lista por ordem crescente
 *  parametro: lst apontador para a lista
